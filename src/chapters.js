...
const chapters = gsap.utils.toArray(["#chapter-1", "#chapter-2", "#chapter-3", "#chapter-4"]);
...
const horizontalScroll = gsap.to(contents, {
  ...
  scrollTrigger: {
    ...
    pin: true,
    scrub: 1,
    snap: 1 / (chapters.length - 1), // only snap between real chapters
...
const clickableElements = document.querySelectorAll('a, .menu-chapter a, .next-chapter a');
